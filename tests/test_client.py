...
def test_install_and_validate(tmp_path):
    ...
    skill = Skill(**{"name": skill_meta["slug"], "version": skill_meta.get("version","0.0.0"), "author": skill_meta.get("author",""), "entrypoint": "scripts/pr-review.sh", "tags": skill_meta.get("tags",[])})
